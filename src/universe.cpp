...
std::array<int32_t, 3> Universe::get_tile(Position /*r*/, Direction /*u*/) const {
  return {0, 0, 0};
}

double Universe::distance_to_tile_boundary(Position /*r_local*/, Direction /*u*/, std::array<int32_t, 3> /*tile*/) const {
  return INF;
}
