...
// MeshPositionFilter::get_indices_tracklength(Position r, const Direction& u_,
// double d_flight){
std::vector<TracklengthDistance> MeshPositionFilter::get_indices_tracklength(
