 ...
 *
 * */
#ifndef ALPHA_POWER_ITERATOR_H
#define ALPHA_POWER_ITERATOR_H
...
class AlphaPowerIterator : public Simulation {
 public:
  AlphaPowerIterator(std::shared_ptr<IParticleMover> i_pm,
                     AlphaParameters i_alpha_params)
      : Simulation(i_pm), alpha_params(i_alpha_params){};
  ~AlphaPowerIterator() = default;
