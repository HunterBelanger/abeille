...
class CylinderPositionFilter : public PositionFilter {
 public:
  ...
  CylinderPositionFilter(Position origin, double radius, 
        double dx, double dy, double dz, 
        std::size_t nx = 1, std::size_t ny = 1, std::size_t nz = 1, 
        Orientation z_ = Orientation::Z);
  ...
  std::pair<double, double> get_scaled_radius_and_angle(const StaticVector3& indices, const Position& r) const;
 ...
 private:
  ...
  double radius_, pitch_x_, pitch_y_, dz_, inv_radius_, inv_pitch_x_, inv_pitch_y_,
      inv_dz_;
