...
struct GeoLilyPad {
  ...
  GeoLilyPad() {}
  GeoLilyPad(PadType t, uint32_t i, uint32_t oi, Position r, std::array<int32_t, 3> ti,
             bool ou)
      : type(t), id(i), offset_index(oi), r_local(r), tile(ti), in_lattice_outside_universe(ou) {}
